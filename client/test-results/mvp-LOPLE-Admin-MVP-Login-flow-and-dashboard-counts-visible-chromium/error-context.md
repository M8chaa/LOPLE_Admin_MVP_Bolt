...
- Name: LOPLE Admin MVP >> Login flow and dashboard counts visible
- Location: /workspace/client/tests/mvp.spec.ts:15:7
...
Call log:
  - navigating to "http://localhost:5173/login", waiting until "load"
    ...
    at /workspace/client/tests/mvp.spec.ts:16:11
```
